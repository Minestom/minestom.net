...
- [Writing your own extension for Minestom](extensions#writing-your-own-extension-for-minestom)
- [How extensions are loaded](extensions#how-extensions-are-loaded)
- [Dependencies](extensions#dependencies)
- [Callback order](extensions#callback-order)
- [Extension Isolation](extensions#extension-isolation)
- [Testing in a dev environment](extensions#testing-in-a-dev-environment)
